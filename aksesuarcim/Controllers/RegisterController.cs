    ...
    public class RegisterController : Controller
    {
        ...
        public async Task<IActionResult> Index(AppUserRegisterDto appUserRegisterDto)
        {
            ...
            if (result.Succeeded)
            {
                ...
                MailboxAddress mailboxAdressFrom = new MailboxAddress("Eticaret Uygulaması", "seyhanyandik@gmail.com");
                ...
                client.Authenticate("seyhanyandik@gmail.com", "ayvs pnsr jumg cdqa");
